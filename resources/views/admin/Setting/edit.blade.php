                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control @error('config_key') is-invalid @enderror"
                                        placeholder="Nhập Tên Config Key" name="config_key" value="{{ ($setting->config_key) }}">
                                    @error('config_key')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control @error('config_value') is-invalid @enderror"
                                        placeholder="Nhập Tên slider" name="config_value" value="{{ ($setting->config_value) }}">
                                    @error('config_value')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{!! $message !!}</strong>
                                        </span>
                            ...
                            <div class="form-group row">
                                <label class="col-md-2">Config Value</label>
                                <div class="col-md-6">
                                    <textarea class="form-control ckeditor_init  @error('config_value') is-invalid @enderror" rows="10" name="config_value">{{ ($setting->config_value) }}</textarea>
